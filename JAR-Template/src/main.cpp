...
void Kerem(){
  ...
  // Brain.Screen.print(isAPressed ? "Basıldı" : "Basılmadı");
}
...
int main()
{
  ...
  intakeUst.setVelocity(127, percent);
  intakeOrta.setVelocity(127, percent);
  intakeAlt.setVelocity(127, percent);
  ...
  Controller1.ButtonA.pressed(Kerem);
  Controller1.ButtonX.pressed(gate);
  Controller1.ButtonY.pressed(load);
  Controller1.ButtonB.pressed(B);
  Controller1.ButtonDown.pressed(park);
